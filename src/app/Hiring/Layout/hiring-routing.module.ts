...
import { AddQuestionsComponent } from 'src/app_Quizz/Modules/add-questions/add-questions.component';
import { AddQuizComponent } from 'src/app/_Quizz/Modules/add-quiz/add-quiz.component';
...
import { QuizPertraineeComponent } from 'src/app/Quizz/Modules/quiz-pertrainee/quiz-pertrainee.component';
...
const routes: Routes = [
  { path:'', component: BusinessHomeComponent,
    ...
    { path: 'ForBusiness', component: HomepageComponent },
    { path: 'tracker', component: TrackBoardComponent },
